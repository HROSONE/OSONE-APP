...
- Escolha persistente entre 30 vozes predefinidas Gemini Live; trocar voz reinicia a sessão atual. A saída vai pelo canal de mídia do Android, com ganho fixo de 140%; ajuste o volume pelos botões do celular. Um buffer inicial curto absorve variações de rede, cresce quando há falta de dados e tenta reduzir cortes. O cancelamento acústico é ativado quando disponível no aparelho.
...
4. Toque em 🎙️ Live e permita acesso ao microfone. Escolha modelo e voz no orbe ou em Ajustes; ajuste o volume com os botões de mídia do celular. Ao sair ou bloquear o app, o microfone é encerrado.
